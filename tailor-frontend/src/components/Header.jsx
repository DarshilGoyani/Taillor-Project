...
const Header = () => {
  ...
  const styles = {
    ...
    avatar: {
      ...
      height: '36px',
      borderRadius: '50%',
      background: 'linear-gradient(45deg, #4a3f35, #7a6b5d)',
      color: '#fff',
      display: 'flex',
      alignItems: 'center',
      justifyContent: 'center',
    ...
    dropdown: {
      ...
      borderRadius: '18px',
      border: '1px solid #e3ddd3',
      boxShadow: '0 15px 35px rgba(74, 63, 53, 0.12)',
      padding: '8px',
        ...
        <div style={styles.rightActions}>
          ...
          <div style={{ position: 'relative' }} ref={dropdownRef}>
            ...
            <div style={styles.dropdown}>
              ...
              <div style={{ ...styles.dropdownItem, color: '#c27d7d' }} className="hover-subtle">
